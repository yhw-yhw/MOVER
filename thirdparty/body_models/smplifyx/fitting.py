...
from .utils_mics.mesh_viewer import MeshViewer
from .utils_mics import misc_utils # as misc_utils
...
class SMPLifyLoss(nn.Module):
    ...
    def __init__(self, search_tree=None,
        ...
        self.robustifier = misc_utils.GMoF(rho=rho)
        self.rho = rho
    ...
    def __init__(self, init_joints_idxs, trans_estimation=None,
        ...
        if trans_estimation is not None:
            self.register_buffer(
                'trans_estimation',
                misc_utils.to_tensor(trans_estimation, dtype=dtype))
        else:
