## borrow it from https://raw.githubusercontent.com/MVIG-SJTU/AlphaPose/41642dbc915abdc4772cf773023938c9bcf3ab9f/alphapose/utils/vis.py
import math
import time
...
def vis_frame_fast(frame, im_res, format='coco'):
    ...
    if len(im_res['result']) > 0:
        ...
        kp_num = im_res['result'][0]['keypoints'].shape[0]
    if kp_num == 17:
        if format == 'coco':
            l_pair = [
        ...
        l_pair = [
            ...
            (1, 2),(2, 3), (3, 4), 
            (8, 9), (8, 12),
            (12, 13), (13, 14), (9, 10), (10, 11), #leg
            (11, 24), (11, 22), (23, 22), (21, 14), (14, 19), (19, 20),# Foot
        ]
        p_color = [(0, 255, 255), (0, 191, 255), (0, 255, 102), (0, 77, 255), (0, 255, 0),  # Nose, LEye, REye, LEar, REar
                   (77, 255, 255), (77, 255, 204), (77, 204, 255), (191, 255, 77), (77, 191, 255), (191, 255, 77),  # LShoulder, RShoulder, LElbow, RElbow, LWrist, RWrist
                   (204, 77, 255), (77, 255, 204), (191, 77, 255), (77, 255, 191), (127, 77, 255), (77, 255, 127),  # LHip, RHip, LKnee, Rknee, LAnkle, RAnkle, Neck
