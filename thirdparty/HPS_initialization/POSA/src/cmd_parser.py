...
def parse_config():
    ...
    parser.add_argument('--cs_name', type=str, default='perspective_cam')
    ...
    # save result as npy
    parser.add_argument('--save', default=False, type=lambda x: x.lower() in ['true', '1'])
    parser.add_argument('--save_dir', type=str, default='$POSA_dir/save_dir')
