#### Auto-decoder: This script is used for optimizing hidden vector for decoder.
#### - input: a sequence of human motion from SAMP;
#### - output: generated object shape;
