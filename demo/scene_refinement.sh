...
scene_init_fn=${input_dir}/smplifyx_results_st0_camera_gp_posaVersion_meanFeetAsInit/model_scene_0_0_lr0.002_end.pth
...
load_all_scene=False
save_dir=${input_dir}/refine_results/scene_reconstruction_s3kind${stage3_kind_flag}_debug/obj_-1
